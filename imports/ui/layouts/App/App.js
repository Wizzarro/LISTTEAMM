      ...
      <StyledApp ready={this.state.ready} loading={props.loading}>
        ...
        <Grid>
          <Switch>
            ...
            <Authenticated exact path="/notes" component={Documents} setAfterLoginPath={setAfterLoginPath} {...props} {...state} />
            <Authenticated exact path="/notes/new" component={NewDocument} setAfterLoginPath={setAfterLoginPath} {...props} {...state} />
            <Route exact path="/notes/:_id" component={ViewDocument} />
            <Authenticated exact path="/notes/:_id/edit" component={EditDocument} setAfterLoginPath={setAfterLoginPath} {...props} {...state} />
